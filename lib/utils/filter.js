...
/**
 * FilterUtils - Utility function collection of filter
 *
 * ####Example:
 *
 *     const padFilter = FilterUtils.createPadFilter(maxScale);
 *     const scaleFilter = FilterUtils.createScaleFilter(4000);
 *     const zoomFilter = FilterUtils.createZoomFilter({x, y, z, s: size, fps, d: frames});
 *
 * @object
 */
