 ...
 * ####Example:
 *
 *     const renderer = new Renderer({ threads: 2 });
 *
 *
 * @class
 */
...
class Renderer extends FFBase {
  ...
  start() {
    ...
    for (let i = this.cursor; i < this.cursor + this.threads; i++) {
  ...
  nextStart() {
    ...
    const index = this.cursor + this.threads - 1;
